      ...
      <div className='flex flex-wrap lg:flex-nowrap justify-center w-full md:w-5/6'>
        <div className="flex justify-center items-center w-60 h-60 mx-2 md:mx-2 my-4 md:my-0">
          <div className="bg-white flex flex-col justify-center items-center w-full h-full rounded-xl shadow-xl border border-gray-200 relative">
            <img src={staff1} alt="" className="w-full h-full object-cover rounded-2xl" />
        ...
        <div className="flex justify-center items-center w-60 h-60 mx-2 md:mx-2 my-4 md:my-0">
          <div className="bg-white flex flex-col justify-center items-center w-full h-full rounded-xl shadow-xl border border-gray-200 relative">
            <img src={staff2} alt="" className="w-full h-full object-cover rounded-2xl" />
            <div style={{ position: "absolute", bottom: -10 }} className="w-5/6 flex justify-center">
        ...
        <div className="flex justify-center items-center w-60 h-60 mx-2 md:mx-2 my-4 md:my-0">
          <div className="bg-white flex flex-col justify-center items-center w-full h-full rounded-xl shadow-xl border border-gray-200 relative">
            <img src={staff3} alt="" className="w-full h-full object-cover rounded-2xl" />
            <div style={{ position: "absolute", bottom: -10 }} className="w-5/6 flex justify-center">
        ...
        <div className="flex justify-center items-center w-60 h-60 mx-2 md:mx-2 my-4 md:my-0">
          <div className="bg-white flex flex-col justify-center items-center w-full h-full rounded-xl shadow-xl border border-gray-200 relative">
            <img src={staff4} alt="" className="w-full h-full object-cover rounded-2xl" />
            <div style={{ position: "absolute", bottom: -10 }} className="w-5/6 flex justify-center">
