        ...
        <div className="flex flex-wrap  justify-evenly">
          <div className="md:w-1/5 flex flex-col justify-center items-center px-4 text-center">
            <div className="bg-white w-20 h-20 rounded-full p-2">
                <img src={smiley} alt="smiley image" className='hover:rotate-180' />
            </div>
            <h3 className="my-3  font-semibold hover:scale-110">Give Happiness</h3>
            <p className="text-xs">
          ...
          <div className="md:w-1/5 flex flex-col justify-center items-center px-4 text-center">
            ...
            <h3 className="my-3 font-semibold hover:scale-110">Build Socially</h3>
            <p className="text-xs">
